...
public class ViewBooks extends JPanel {
    ...
    public ViewBooks() {
        ...
        searchBtn.setToolTipText("Search books by title or author");
        ...
        refreshBtn.setToolTipText("Reload all books");
        searchPanel.add(new JLabel("Search:"));
        searchPanel.add(searchField);
        searchPanel.add(searchBtn);
        searchPanel.add(refreshBtn);

        tableModel = new DefaultTableModel(new String[]{"ID", "Title", "Author", "Quantity"}, 0);
